...
const categorias = {
    frutas: ["uva", "banana", "morango", "melancia", "pera", "damasco", "pessego"],
    profissoes: ["medico", "professor", "dentista", "soldador", "professor", "engenheiro", "pescador"],
    animais: ["cachorro", "gato", "galo", "cavalo", "vaca", "lobo", "borboleta"],
    cores: ["preto", "branco", "amarelo", "marrom", "azul", "vermelho", "dourado"]
};
